setwd("/Users/MiSelf2/Desktop/Simulations/Biscuits")
library(tidyverse)
...
## Whats the probability of not removing a max die on the first role
...
facesVector <- c(rep(6, nSixSided), rep(8, nEightSided), rep(10, nTenSided), rep(12, nTwelveSided))
